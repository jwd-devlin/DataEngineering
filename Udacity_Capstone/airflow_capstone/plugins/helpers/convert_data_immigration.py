...
class ImmigrationConvert:

   country_map = {"582": 'MEXICO',
                   "236": 'AFGHANISTAN',
                   "101": 'ALBANIA',
                   "316": 'ALGERIA',
                   "102": 'ANDORRA',
   ...
   port_codes = {'ALC': 'ALCAN, AK             ',
                  ...
                  'VIC': 'VICTORIA, CANADA      ',
                  'WIN': 'WINNIPEG, CANADA      ',
                  'AMS': 'AMSTERDAM-SCHIPHOL, NETHERLANDS , Overseas',
                  'ARB': 'ARUBA, NETH ANTILLES , Overseas',
                  'BAN': 'BANKOK, THAILAND  , Overseas    ',
                  'BEI': 'BEICA #ARPT, ETHIOPIA, Overseas',
                  'PEK': 'BEIJING CAPITAL INTL, PRC, Overseas',
                  'BDA': 'KINDLEY FIELD, BERMUDA, Overseas',
                  'BOG': 'BOGOTA, EL DORADO #ARPT, COLOMBIA, Overseas',
                  'EZE': 'BUENOS AIRES, MINISTRO PIST, ARGENTINA, Overseas',
                  'CUN': 'CANCUN, MEXICO, Overseas',
                  'CRQ': 'CARAVELAS, BA #ARPT, BRAZIL, Overseas',
                  'MVD': 'CARRASCO, URUGUAY, Overseas',
                  'DUB': 'DUBLIN, IRELAND      , Overseas ',
                  'FOU': 'FOUGAMOU #ARPT, GABON, Overseas',
                  'FBA': 'FREEPORT, BAHAMAS     , Overseas ',
                  'MTY': 'GEN M. ESCOBEDO, Monterrey, MX, Overseas',
                  'HMO': 'GEN PESQUEIRA GARCIA, MX, Overseas',
                  'GCM': 'GRAND CAYMAN, CAYMAN ISLAND, Overseas',
                  'GDL': 'GUADALAJARA, MIGUEL HIDAL, MX, Overseas',
                  'HAM': 'HAMILTON, BERMUDA  , Overseas   ',
                  'ICN': 'INCHON, SEOUL KOREA, Overseas',
                  'IWA': 'INVALID - IWAKUNI, JAPAN, Overseas',
                  'CND': 'KOGALNICEANU, ROMANIA, Overseas',
                  'LAH': 'LABUHA ARPT, INDONESIA, Overseas',
                  'DUR': 'LOUIS BOTHA, SOUTH AFRICA, Overseas',
                  'MAL': 'MANGOLE ARPT, INDONESIA, Overseas',
                  'MDE': 'MEDELLIN, COLOMBIA, Overseas',
                  'MEX': 'JUAREZ INTL, MEXICO CITY, MX, Overseas',
                  'LHR': 'MIDDLESEX, ENGLAND, Overseas',
                  'NBO': 'NAIROBI, KENYA     , Overseas   ',
                  'NAS': 'NASSAU, BAHAMAS   , Overseas    ',
                  'NCA': 'NORTH CAICOS, TURK & CAIMAN, Overseas',
                  'PTY': 'OMAR TORRIJOS, PANAMA, Overseas',
                  'SPV': 'PAPUA, NEW GUINEA, Overseas',
                  'UIO': 'QUITO (MARISCAL SUCR), ECUADOR, Overseas',
                  'RIT': 'ROME, ITALY    , Overseas       ',
                  'SNO': 'SAKON NAKHON #ARPT, THAILAND, Overseas',
                  'SLP': 'SAN LUIS POTOSI #ARPT, MEXICO, Overseas',
                  'SAN': 'SAN SALVADOR, EL SALVADOR, Overseas',
                  'SRO': 'SANTANA RAMOS #ARPT, COLOMBIA, Overseas',
                  'GRU': 'GUARULHOS INTL, SAO PAULO, BRAZIL, Overseas',
                  'SHA': 'SHANNON, IRELAND    , Overseas ',
                  'HIL': 'SHILLAVO, ETHIOPIA, Overseas',
                  'TOK': 'TOROKINA #ARPT, PAPUA, NEW GUINEA, Overseas',
                  'VER': 'VERACRUZ, MEXICO, Overseas',
                  'LGW': 'WEST SUSSEX, ENGLAND  , Overseas',
                  'ZZZ': 'MEXICO Land (Banco de Mexico), Overseas ',
                  'CHN': 'No PORT Code (CHN), Overseas',
                  'CNC': 'CANNON CORNERS, NY',
                  'MAA': 'Abu Dhabi, Overseas',
                  'AG0': 'MAGNOLIA, AR',
                  'BHM': 'BAR HARBOR, ME',
                  'BHX': 'BIRMINGHAM, AL',
                  'CAK': 'AKRON, OH',
   ...
   def remove_invalid_ports(self, data_frame, port_code):
         port_all_map = self.port_codes
         df_port_all_map = pd.DataFrame(list(port_all_map.items()), columns=[port_code, 'port_names'])
